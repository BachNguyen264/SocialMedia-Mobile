...
import com.CT060104.socialmedia.utils.AuthInterceptor;

public class ApiClient {
    private static final String TAG = "ApiClient";
    private static final String BASE_URL = "http://10.0.2.2:3000"; // For Android emulator (http demo)
    //private static final String BASE_URL = "https://8wnjdh2b-3000.asse.devtunnels.ms/"; //(tunnel https demo)
